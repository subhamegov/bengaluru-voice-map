  ...
  return (
    <AppLayout>
      <div className="space-y-8 md:space-y-12">
        ...
        {/* ── Ward Governance ── */}
        <section aria-labelledby="ward-governance-heading">
          <h2 id="ward-governance-heading" className="text-xl md:text-2xl font-bold font-display flex items-center gap-2 mb-4">
