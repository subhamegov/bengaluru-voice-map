    ...
    <div className="space-y-6 sm:space-y-8">
      ...
      <section className="space-y-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl font-bold text-foreground">Community Feedback</h2>
            <p className="text-sm text-muted-foreground">Appreciations and positive feedback received in your ward</p>
          </div>
        </div>
